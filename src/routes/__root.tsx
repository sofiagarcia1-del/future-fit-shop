  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="text-center">
        ...
        <a href="/" className="mt-6 inline-block rounded-full btn-primary-bg px-6 py-2.5 text-sm">
          Volver al inicio
        </a>
      </div>
    </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Tryfit — Pruébate la moda antes de comprar" },
      {
        name: "description",
        content:
          "Tienda multimarca con experiencia de Virtual Try-On con IA. Sube una foto y pruébate prendas antes de comprar.",
      },
      { name: "author", content: "Tryfit" },
      { property: "og:title", content: "Tryfit — Moda con IA" },
      {
        property: "og:description",
        content: "Pruébate cualquier prenda virtualmente con IA antes de comprar.",
      },
